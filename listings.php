...
<body>
    ...
    <header>
        <div class=" container jumbotron jumbotron-image col-lg-11 img-fluid mt-5 col-md-12 col-sm-11"
            style="background-image: url('images/listingcover.jpg'); background-size:cover; max-width:100%; object-fit:cover">
            <div class="container">
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input class="form-control form-control-lg" placeholder="Enter Location or Landmark"
                                        type="text">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2 no-radius form-control-lg">
                                        <option value="">Locations</option>
                                        <option value="AL">Kathmandu</option>
                                        <option value="AK">Pokhara</option>
                                        <option value="AZ">Chitwan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <button type="submit"
                                    class="btn btn-lg btn-success btn-block  font-weight-bold">SEARCH</button>
                            </div>
                        </div>
                        </form>
                    </div>
    ...
    <div class="Available p-2">
        ...
        <a href="info.php?id=<?php echo $row['id'];?>">
            <p class="float-right mr-5"><u><b>View all</b></u></p>
        </a>
        <p class="text-muted ml-5">The most recent real-estate right now.</p>

        <section class=" row listings mt-5 ml-4">
        <?php
                            ...
                            // $result = mysqli_fetch_array($query);
                             ...
                             while($result = mysqli_fetch_array($query)){
                             	?>
<a href="info.php?id=(variable of the id of the chosen link)"> 
            <div class="row ">
   ...
   $result['pic'];  ?>" alt="Listings" style="height:190px; width:100%">
    ...
    <!-- <div class="Available p-2">
        <h3 class="ml-5">
            <dt>Lands Available in Nepal
            </dt>
        </h3>
        <p class="text-muted ml-5">Avoid the brokers and choose yourself.</p>
        <section class=" row lands mt-5 ml-4">
            <?PHP

	$con = mysqli_connect('localhost','root','');
	mysqli_select_db($con,'roomkhoji');
    ...
    $query = "SELECT  `image`, `name`, `location`, `area`, `price` FROM `lands` order by id ASC";
    ...
    ?>
            ...
            <div class="row">
                ...
                <div class="product-card col-lg-11 col-md-11 col-sm-11 container-fluid mx-4 px-4">
                    ...
                    <div class="product-tumb img-fluid">
                        <img src="<?php echo 
    $product['image'];  ?>" alt="Lands" style="height:180px; width:100%">
                    </div>

                    <div class="product-details mt-3">
                        <span class="product-catagory">
                            <h6><b><?php echo $product['name'];  ?>
                        </span></b></h6>
                        <p class="text-muted"><i class="fa fa-map-marker mr-2"></i><?php echo $product['location'];  ?>
                        </p>
                        <p class="text-muted"><i class="fa fa-map mr-2"></i><?php echo $product['area'];  ?></p>
                        <h6>NPR.<?php echo $product['price'];  ?> per Aana</h6>
                    </div>
                </div>
