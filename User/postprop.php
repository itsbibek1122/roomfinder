  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">Alerts</a>
        ...
        <div class="card bg-light mb-3">
          <div class="card-body">
            ...
            <div class="type mt-2">
              ...
              <button type="button" class="btn btn-sm btn-outline-primary mx-1"> <i
                  class="fa fa-home"></i><br>House</button>
              <button type="button" class="btn btn-sm btn-outline-success mx-1"> <i
                  class="fa fa-map"></i><br>Land</button>
              <button type="button" class="btn btn-sm btn-outline-primary mx-1"> <i
                  class="fa fa-building"></i><br>Flat</button>
            </div>
        ...
        <div class="card bg-light mb-3">
          <div class="card-body">
            <div class="ownername">
              ...
              <div class="form-group col-md-5">
                <input type="text" class="form-control" name="ownername" id="ownname" placeholder="Ownername" required>
              </div>

            </div>
            <div class="ownernumber">
              <p><b>Ownernumber<span style="color: red">*</span>:</b></p>
